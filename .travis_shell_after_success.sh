...
if [ "$TRAVIS_REPO_SLUG" == "dendevs/plpadaptability" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "7.0" ]; then
...
# refs:http://rootslabs.net/blog/511-publier-automatiquement-phpdoc-github-travis-ci 
